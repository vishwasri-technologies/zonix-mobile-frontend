...
const Hostel2 = () => {
  ...
  const defaultHostel = {
    name: 'Hostel 2',
    image: require('./assets/hostel2.jpg'), // Default image for Hostel 2
    price: '₹400/day',
    contactName: 'Kumar',
      ...
      <View style={styles.overlay}>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.hostelCard}>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate('Hostel2Info', { hostel: currentHostel })} // Navigate to Hostel1Info or a new Hostel2Info
          ...
          <View style={styles.popularContactsContainer}>
            ...
            <View style={styles.popularContactCard}>
              <Image source={require('./assets/hostel3.jpg')} style={styles.popularContactImage} />
              <Text style={styles.popularContactText}>Hostel 3</Text> {/* Screenshot shows Hostel 3 here */}
            </View>
          </View>
        </ScrollView>
